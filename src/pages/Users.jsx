...
const API_BASE = 'https://vennila-accessoriesbckend.onrender.com/api';
                            ...
                            >
                                <td className="p-5">
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 bg-gray-100 flex items-center justify-center text-gray-600 font-bold group-hover:bg-[rgb(0, 184, 148)] group-hover:text-white transition-colors">
                                            <User size={18} />
                                        </div>
                                ...
                                <td className="p-5">
                                    <div className="flex items-center gap-2 text-gray-600">
                                        <Store size={16} className="text-[rgb(0, 184, 148)]" />
    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center py-20 gap-4">
                <RefreshCw size={32} className="text-[rgb(0, 184, 148)] animate-spin" />
    ...
    if (error) {
        return (
            <div className="flex flex-col items-center justify-center py-20 gap-4">
                ...
                <button onClick={onRefresh} className="mt-2 px-6 py-2 bg-black text-white text-sm font-bold uppercase tracking-wide hover:bg-[rgb(0, 184, 148)] transition-colors">
                    Retry
                </button>
            </div>
        );
                                ...
                                return (
                                    <React.Fragment key={user._id || idx}>
                                        ...
                                        >
                                            ...
                                            <td className="p-5">
                                                {sub?.purchaseDate ? (
                                                    <div className="flex items-center gap-1.5 text-xs text-gray-600">
                                                        <Calendar size={12} className="text-[rgb(0, 184, 148)]" />
                                            ...
                                            <td className="p-5">
                                                {hasHistory ? (
                                                    <div className="flex items-center gap-1 text-xs text-[rgb(0, 184, 148)] font-bold">
                                            ...
                                            <tr>
                                                <td colSpan="7" className="p-0">
                                                    <motion.div
                                                        ...
                                                        className="bg-gray-50 border-b-2 border-[rgb(0, 184, 148)] px-8 py-5"
                                                    >
                                                        {/* RC Info */}
                ...
                <div className="flex items-center gap-4">
                    {activeTab === 'subscriptions' && (
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2.5 bg-black text-white text-xs font-bold uppercase tracking-wide hover:bg-[rgb(0, 184, 148)] transition-colors"
                        >
                    ...
                    <div className="relative w-96">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-3 bg-white border-b-2 border-gray-200 focus:border-[rgb(0, 184, 148)] outline-none"
                        />
                    </div>
                </div>
            </div>
                    ...
                    return (
                        <button
                            ...
                            className={`relative flex items-center gap-2.5 px-8 py-4 text-sm font-bold uppercase tracking-wide transition-all duration-200
                                ${isActive
                                    ? 'text-[rgb(0, 184, 148)] bg-orange-50/60'
                        ...
                        >
                            ...
                            {tab.count > 0 && (
                                <span className={`ml-1 px-2 py-0.5 text-[10px] font-black rounded-full
                                    ${isActive ? 'bg-[rgb(0, 184, 148)] text-white' : 'bg-gray-200 text-gray-500'}`}>
                                    {tab.count}
                                </span>
                            )}
                            {isActive && (
                                <motion.div
                                    ...
                                    className="absolute bottom-0 left-0 right-0 h-0.5 bg-[rgb(0, 184, 148)]"
